...
const Expertise = () => {
        ...
        <div className="w-full bg-[#FAF4EC] py-20 px-6">
            <div className="max-w-7xl mx-auto">
                <div className="space-y-10">
                    ...
                    {/* CARD 1 - WHITE */}
                    <div className="bg-white rounded-2xl p-10 md:p-16 flex flex-col md:flex-row justify-between min-h-[500px] md:min-h-[600px] cursor-pointer">
                        <div className="flex flex-col max-w-2xl">
                            <div className="relative">
                                ...
                                <div className="relative z-10 pr-24 md:pr-32">
                                    <span className="text-lg text-black font-semibold bg-[#eae4d8] px-2 py-1 rounded-md">
                                        Expertise
                                    </span>
  ...
  hover:shadow-md">
                    ...
                    {/* CARD 2 - PINK */}
                    <div className="bg-[#fcb8fa] rounded-[40px] p-10 md:p-16 flex flex-col md:flex-row justify-between min-h-[500px] md:min-h-[600px] cursor-pointer">
                        <div className="flex flex-col max-w-2xl">
                            <div className="relative">
  ...
  hover:shadow-md">
                    ...
                    {/* CARD 3 - GREEN */}
                    <div className="bg-[#33c791] rounded-[40px] p-10 md:p-16 flex flex-col md:flex-row justify-between min-h-[500px] md:min-h-[600px] cursor-pointer">
                        <div className="flex flex-col max-w-2xl">
                            <div className="relative">
  ...
  hover:shadow-md">
                    ...
                    {/* CARD 4 - BLUE */}
                    <div className="bg-[#3b82f6] rounded-[40px] p-10 md:p-16 flex flex-col md:flex-row justify-between min-h-[500px] md:min-h-[600px] cursor-pointer">
                        <div className="flex flex-col max-w-2xl">
                            <div className="relative">
